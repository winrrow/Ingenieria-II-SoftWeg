...
<head>
	...
	<body id="color">		
			<div id="paisajemiperfil">
				<h1 id="tituloperfil"> Mis Solicitudes Pendientes </h1>
			</div>
									...
									echo '<form  method="POST">';
									 echo '<div id=imagen><img src="'.$resultado["fotocouch"].'"width=100% height=100%/></div>';
												echo "<div id=info>";	
													...
													echo'<p name="fechadesde2" id=fechadesde2>Fecha Desde: '.$fecha.'</p>';
													...
													echo'<p name="hasta2" id=hasta2>'.$fecha1.'</p>';
