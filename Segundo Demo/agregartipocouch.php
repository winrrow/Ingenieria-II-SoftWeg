		          ...
		          <div id="container2"> 
						   <div id="formbot">  
									<div id="izquierdo">     
								     	...
								     	<p style="color: white; font-size: 20; text-align: left">Tipos de Couch Habilitados:</p></br>
									   		 <?php 	
												...
												while($row = mysql_fetch_array($sql)){
													...
													if($habilitado == 'si'){	
														echo '<form action="abmtipocouch.php" style=width:100% method="POST">';
															...
															<input type="submit" style=width:20% name="deshabilitar"  	value="deshabilitar">
									...
									<div id="derecho">	
									<p style="color: white; font-size: 20; text-align: left">Tipos de Couch Deshabilitados:</p></br>     
											<?php
											    $sql=mysql_query("SELECT * FROM tipo_couchs",$con);
												while($row = mysql_fetch_array($sql)){
													$habilitado=$row['habilitado'];
