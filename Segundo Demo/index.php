...
<title>Bienvenido a Couchinn</title>
 	...
 	<body>
		...
		<?php
					...
					$todos = mysql_query("SELECT tipo_couchs.nombre_tipocouch, couchs.titulo, couchs.provincia, couchs.ciudad, couchs.id_tipo_couch, couchs.megusta, couchs.nomegusta, couchs.capacidad, couchs.descripcion,couchs.fecha_desde,couchs.fecha_hasta, couchs.fotocouch, usuarios.nombre_usuario FROM couchs INNER JOIN tipo_couchs on couchs.id_tipo_couch=tipo_couchs.id_tipo_couch INNER JOIN usuarios on usuarios.mail=couchs.mail");
