...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="styles/uploadCoach.css">
            ...
            function submitSolicitud(){
                ...
                if ( fechasok ){
                document.getElementById("formulariodealtacoach").submit();
                }         
    ...
    <div class ="container">
     ...
     <input class="form-control textInput2" id="desde" name="desde" required="" type="date" min=<?php echo date("Y-m-d"); ?>></br>
        </div>
        
        <div id="divhasta">
        
            <p class="textInput">Disponible Hasta:</p>
            <input class="form-control textInput2" id="hasta" name="hasta" required="" min=<?php echo date ( "Y-m-d",strtotime( '+1 day' , strtotime ( date("Y-m-d") ) )) ?>  type="date">
        </div>
         
        <button class="btn btn-lg btn-success btn-blockx" id="publicarCoach" type="submit" onclick="submitSolicitud()" onclick="window.location=miperfil.php"">Publicar</button>
