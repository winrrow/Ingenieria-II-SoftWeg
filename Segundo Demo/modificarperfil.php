    ...
    <body>
      ...
      <form class="form-signin" method="POST"  action="actualizarperfil.php"  enctype="multipart/form-data">
		       ...
		       <div id="infoperfil" class="col-md-6"> 
					...
					<span class="textInput subtitulosModificar" id="mailspan">Mail</span>
			        ...
			        <p class="textInput subtitulosModificar" id="info">Información sobre usted</p>
			        <div id="informacion">
			        ...
			        <div class="fotoPremiumAltaCoach" >
                                        ...
                                        <p class="subtitulosModificar">Cambiar foto</p>
                     ...
                     <button class="btn btn-lg btn-success btn-blockx" id="modificar" type="submit">Modificar Perfil</button>       
			       	 <a id="miperfil" href="cambiar_contrasena.php" class="btn btn-lg btn-success btn-blockx"> Cambiar Contraseña </a>
